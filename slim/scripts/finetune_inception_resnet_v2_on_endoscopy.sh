...
do
    ...
    do
        ...
        DATASET_FILE_PATTERN=cls_data_${DATA_SUBNAMES[$i]}_${k}_%s_*.tfrecord

        # About training
        TRAIN_DIR=${PROJECTS_DIR}/TRAIN/CLASSIFICATION/${DATASET_NAME}-models/${MODEL_NAME}_${PREPROCESSING_NAME}/${START_DATE}/${k}
        TRAIN_BATCH_SIZE=32
        EVAL_BATCH_SIZE=2
